...
app.post(
  ...
  async (req, res) => {
    try {
      ...
      // Şifre değişikliğinden hemen sonra Supabase Auth bazen yeni şifreyi
      // birkaç yüz milisaniye gecikmeyle kabul eder. Bu yüzden tek seferlik
      // signIn yerine kısa aralıklarla yeniden deniyoruz.
      const loginEmail = String(
        userData.user.email || entry.email || ""
      ).trim().toLowerCase();
