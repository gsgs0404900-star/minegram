...
app.post("/api/login", async (req, res) => {
  try {
    ...
    /* =====================================================
       4 — GERÇEK SUPABASE ŞİFRE KONTROLÜ
    ===================================================== */
    ...
    /* =====================================================
       7 — PROFİLİ AUTH ID İLE TEKRAR BUL
    ===================================================== */
    ...
    if (!profile) {
      ...
      return res.status(500).json({
        ok: false,
        error:
          "Giriş başarılı fakat Minegram profili bulunamadı."
      });
    }
